...
document.addEventListener("DOMContentLoaded", function() {
    // Verifica se o usuário está logado, baseado em uma chave armazenada (por exemplo, 'loggedIn')
    var loggedIn = localStorage.getItem('loggedIn');
    if (loggedIn === 'true') {
      // Se o usuário estiver logado, exibe os links "Perfil" e "Sair" e esconde "Entrar" e "Registrar"
      document.getElementById("loginLink").style.display = "none";
      document.getElementById("registerLink").style.display = "none";
      document.getElementById("profileLink").style.display = "inline";
      document.getElementById("logoutLink").style.display = "inline";
    } else {
      // Se não estiver logado, mostra "Entrar" e "Registrar" e esconde "Perfil" e "Sair"
...
localStorage.setItem("username", "username"); // opcional, para uso em exibição
